...
const enUSMessages = {
  ...
  agentStatusCompressing: 'Compressing',
  ...
  agentCompressingNow: 'compressing context',
  agentCompressingAria: 'Agent is compressing conversation context',
...
const zhCNMessages: MessageCatalog = {
  ...
  agentStatusCompressing: '正在压缩',
  agentStatusAwaitingApproval: '等待确认',
  agentStatusReady: '就绪',
  agentThinkingNow: '刚刚',
  agentThinkingAria: 'Agent 正在思考',
  agentCompressingNow: '正在压缩上下文',
  agentCompressingAria: 'Agent 正在压缩会话上下文',
